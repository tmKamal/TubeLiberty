...
5. The TubeLiberty extension should now be visible in your list of extensions.

## Usage

Once installed, the extension will automatically start monitoring your YouTube usage. There are no additional steps required to start using the extension.
